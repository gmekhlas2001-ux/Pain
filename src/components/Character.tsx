...
export const Character: React.FC<CharacterProps> = ({ bodyType, gender, color, skyOffset }) => {
  ...
  const renderCatCharacter = () => (
    <>
      ...
      <motion.g style={{ originX: '20px', originY: '75px', rotate: armRotation, y: armY }}>
        <ellipse cx="20" cy="75" rx="6" ry="8" fill={color} opacity="0.9" />
      </motion.g>

      <ellipse cx="60" cy="75" rx="6" ry="8" fill={color} opacity="0.9" />
  ...
  const renderHumanCharacter = () => {
    ...
    return (
      <>
        ...
        <motion.g style={{ originX: '22px', originY: '70px', rotate: armRotation, y: armY }}>
          <rect x="18" y="60" width="8" height="18" rx="4" fill="#ffdbac" opacity="0.9" />
        </motion.g>

        <rect x="54" y="60" width="8" height="18" rx="4" fill="#ffdbac" opacity="0.9" />
  ...
  const renderBearCharacter = () => (
    <>
      ...
      <motion.g style={{ originX: '18px', originY: '76px', rotate: armRotation, y: armY }}>
        <ellipse cx="18" cy="76" rx="8" ry="10" fill={color} opacity="0.9" />
      </motion.g>

      <ellipse cx="62" cy="76" rx="8" ry="10" fill={color} opacity="0.9" />
  ...
  const renderFoxCharacter = () => (
    <>
      ...
      <motion.g style={{ originX: '21px', originY: '74px', rotate: armRotation, y: armY }}>
        <ellipse cx="21" cy="74" rx="6" ry="9" fill={color} opacity="0.9" />
      </motion.g>

      <ellipse cx="59" cy="74" rx="6" ry="9" fill={color} opacity="0.9" />
